...
for init in test_inits:
    ...
    # Interpolate sunspot values between days, and extrapolate beyond last recorded date
    ...
    def sunspot_rho_q(dates_since_launch, param_vals):    
        ...
        for date in dates_since_launch:
            ...
            t_vals = sunspot_days_since_launch_fit_array[
            (sunspot_days_since_launch_fit_array + param_vals[4] >=0) & (sunspot_days_since_launch_fit_array <= date - param_vals[4])
            ]
            
            selected_spots_1 = sunspot_interp(t_vals)
            ...
            selected_spots_2 = sunspot_interp(t_vals+1)
...
# =============================================================================
    fit_sunspot = scipy.optimize.minimize(chi_squared, initial_values, args=(sunspot_rho_q, days, rho_q_pres_array, 
                                                                      sunspot_error_array), method = 'L-BFGS-B')
