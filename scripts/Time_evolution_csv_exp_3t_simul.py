...
def rho_fit(x, param_vals):
    ...
    for days in x:
        ...
        elif days > 1366 and days < 4166:
            calc_vals.append(param_vals[2]*(days-1366)+param_vals[0]*1366+param_vals[1]) # m2=vals2
        elif days > 4166 and days < 8166:
            calc_vals.append(param_vals[3]*(days-4166)+param_vals[2]*(4166-1366)+param_vals[0]*1366+param_vals[1]) #m3=vals3
        elif days > 8166:
            calc_vals.append(param_vals[4]*(days-5166)+param_vals[3]*(5166-4166)+param_vals[2]*(4166-1366)+param_vals[0]*1366+param_vals[1]) #m4=vals4
    return (calc_vals)

print('RHO_Q FIT RESULTS')
initial_values=np.array([0,0,0,0,0])
deg_freedom = len(rho_fit_days_list) - initial_values.size
print('DoF = {}'.format(deg_freedom))
bnds = ((0,10) ,(-10, 10),(0,10),(0,10),(0,10))
...
sol3 = fit.x[3]
sol4 = fit.x[4]
fit_line_rho = rho_fit(rho_fit_days, [sol0,sol1,sol2,sol3,sol4])
