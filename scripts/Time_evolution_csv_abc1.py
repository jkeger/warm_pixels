...
csv_path = path.join("csv_files_abc1")
...
plt.savefig('abc1_plots/Beta(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
ax_day.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('abc1_plots/a,b,c(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
ax_day.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('abc1_plots/tau_a,tau_b,tau_c(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
ax_day.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('abc1_plots/CCDGAIN(MJD)', bbox_inches="tight")
plt.show()
...
plt.savefig('abc1_plots/correction_metrics(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('abc1_plots/Notch(MJD)', bbox_inches="tight")
plt.show()
...
plt.savefig('abc1_plots/Rho_q(MJD)', bbox_inches="tight")
plt.show()
...
plt.ylim(-25,25)
plt.gca().axes.get_yaxis().set_ticks([])
plt.savefig('abc1_plots/Rho_q_post_zoom(MJD)', bbox_inches="tight")
plt.show()
