...
starting_directory = r'C:\Users\chipe\Documents\Durham University\warm_pixels\scripts\2024_july_opt2_beta584_notch511_cosine_v2'
...
fit_sunspot_line = sunspot_rho_q_cosine(days, param_vals = [-0.0104, 0.0004669, 0.04391, -282.3], 
cycle_length = 11.0)
...
plt.savefig('Rho_q(MJD)_cosine', bbox_inches="tight")
plt.savefig('Rho_q(MJD)_cosine.pdf', bbox_inches="tight")
plt.show()
...
# =============================================================================
#plt.gca().axes.get_yaxis().set_ticks([])
plt.savefig('Rho_q_post_zoom(MJD)_cosine', bbox_inches="tight")
plt.savefig('Rho_q_post_zoom(MJD)_cosine.pdf', bbox_inches="tight")
plt.show()
...
# 
# # Save to CSV
# df.to_csv('2024_july_opt2_beta584_notch511_cosine_OUTPUTS.csv', index=False)
# =============================================================================
