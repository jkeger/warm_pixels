...
starting_directory = r'C:\Users\chipe\Documents\Durham University\warm_pixels\scripts\2024_july_opt2_beta584_notch511_sunspot'
...
fit_sunspot_line = sunspot_rho_q_timelag(days, param_vals = [0.08981, 5.5738e-04, -3.6802e-06, 0.83093], 
t_lag=430)
...
#ax.scatter(days, fit_sunspot_line, color='orange',zorder=10)
ax.set_xlabel("Days since launch", fontsize=12)
ax.set_xlim(-500, max(days)+500)
