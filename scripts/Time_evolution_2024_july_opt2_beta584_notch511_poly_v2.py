...
starting_directory = r'C:\Users\chipe\Documents\Durham University\warm_pixels\scripts\2024_july_opt2_beta584_notch511_poly_v2'
...
fit_sunspot_line = sunspot_rho_q_polynomial(days, param_vals = [4.731e-4, -0.0322])
...
plt.savefig('Rho_q(MJD)_poly', bbox_inches="tight")
plt.savefig('Rho_q(MJD)_poly.pdf', bbox_inches="tight")
plt.show()
...
# =============================================================================
#plt.gca().axes.get_yaxis().set_ticks([])
plt.savefig('Rho_q_post_zoom(MJD)_poly', bbox_inches="tight")
plt.savefig('Rho_q_post_zoom(MJD)_poly.pdf', bbox_inches="tight")
plt.show()
...
# 
# # Save to CSV
# df.to_csv('2024_july_opt2_beta584_notch511_poly_OUTPUTS.csv', index=False)
# =============================================================================
