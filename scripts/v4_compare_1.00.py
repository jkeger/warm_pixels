...
#                 line = stacked_lines1.stacked_line_for_indices(
#                     row_index=i_row,
#                     flux_index=i_flux,
...
#     noise_all = np.sqrt(np.square(noise_all_temp)+1**2)  
# 
...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch(x=pixels, 
                                           rho_q=float(2.8838093714344), 
                                          ...
                                          # n_e=line.model_flux, 
                                           ...
                                           beta=float(0.5838888133902094), 
                                           w=w, 
                                           A=float(0.18425264814986), 
                                           B=float(0.8150693878589), 
                                           C=float(0.0006779639912399826), 
                                           tau_a=float(0.49140351551741857), 
                                           tau_b=float(5.973581877764456), 
                                           tau_c=float(62.66258928787312),
                                           notch=float(167.02359746202455)
                                          )
                print('Done!')
...
cosma_dataset_path = path.join(cosma_path, "paolo", "datasets", '02_2023')
...
cosma_dataset_path = path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo", "stock_bia_v4_1.0", "02_2023_stock_bia_v4_1.0")
cosma_path = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6")
cosma_output_path = path.join(cosma_path, "output")
workspace_path = "/cosma/home/durham/dc-barr6/warm_pixels_workspace/"
#config_path = path.join(workspace_path, "cosma", "config")
...
Paolo_autofit_global_50_after(
    ...
    save_path=Path(cosma_output_path)/f"v4_comp_{const_fix}.png"
)
