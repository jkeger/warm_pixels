...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.71554275925858), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.5950941910079236), 
                                           w=w, 
                                           A=float(0.12465321515865), 
                                           B=float(0.32660924930019), 
                                           C=float(0.54873753554116), 
                                           tau_a=float(0.44965756480587626), 
                                           tau_b=float(3.6434724819506905), 
                                           tau_c=float(16.463056667506056),
                                           notch=float(107.9878758266534)
                                          )
                print('Done!')
...
cosma_dataset_path = path.join(path.sep, "cosma", "home", "dphgals", "rjm", "data", "hst", "cte_all", "2023_07_b")
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_freeparams_1.0", "2023_07_b_2024_july_freeparams_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_b_fp.pdf",
    save_path_newfig1=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_b_newfig1_fp3plt.pdf",
    save_path_newfig2=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_b_newfig2_fp3plt.pdf",
    save_path_newfig3=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_b_newfig3_fp3plt.pdf"
)
