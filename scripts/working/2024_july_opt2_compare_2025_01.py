...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.72772436164768), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.6271693162691793), 
                                           w=w, 
                                           A=float(0.1305645591623), 
                                           B=float(0.36201357147482), 
                                           C=float(0.50742186936288), 
                                           tau_a=float(0.4166057798021686), 
                                           tau_b=float(3.5117152404066667), 
                                           tau_c=float(16.855299520709064),
                                           notch=float(198.30923700035373)
                                          )
                print('Done!')
...
cosma_dataset_path = path.join(path.sep, "cosma", "home", "dphgals", "rjm", "data", "hst", "cte_april_25", "2025_01_TmidLong")
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_opt2_freeparams_1.0", "2025_01_TmidLong_2024_july_opt2_freeparams_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_2025_01_TmidLong.pdf"
)
