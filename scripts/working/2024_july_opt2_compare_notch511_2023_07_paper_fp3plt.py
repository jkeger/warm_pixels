...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.56979575169508), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.5955807386747995), 
                                           w=w, 
                                           A=float(0.12431799619558), 
                                           B=float(0.30343415433941), 
                                           C=float(0.5722478494650101), 
                                           tau_a=float(0.4193746497644131), 
                                           tau_b=float(3.3841049534009575), 
                                           tau_c=float(13.638568554898526),
                                           notch=float(106.39074861034612)
                                          )
                print('Done!')
...
cosma_dataset_path = path.join(path.sep, "cosma", "home", "dphgals", "rjm", "data", "hst", "cte_all", "2023_07_a")
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_freeparams_1.0", "2023_07_a_2024_july_freeparams_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_a_fp.pdf",
    save_path_newfig1=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_a_newfig1_fp3plt.pdf",
    save_path_newfig2=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_a_newfig2_fp3plt.pdf",
    save_path_newfig3=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2023_07_a_newfig3_fp3plt.pdf"
)
