...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.63468304737247), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.5730982036069964), 
                                           w=w, 
                                           A=float(0.11192665152809), 
                                           B=float(0.20236049047222), 
                                           C=float(0.6857128579996901), 
                                           tau_a=float(0.4015200783545682), 
                                           tau_b=float(2.5579145621418458), 
                                           tau_c=float(11.235519655083095),
                                           notch=float(74.84285013377291)
                                          )
                print('Done!')
...
cosma_dataset_path = path.join(path.sep, "cosma", "home", "dphgals", "rjm", "data", "hst", "cte_all", "2024_10_Llate")
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_freeparams_1.0", "2024_10_Llate_2024_july_freeparams_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2024_10_Llate_fp.pdf",
    save_path_newfig1=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2024_10_Llate_newfig1_fp3plt.pdf",
    save_path_newfig2=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2024_10_Llate_newfig2_fp3plt.pdf",
    save_path_newfig3=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2024_10_Llate_newfig3_fp3plt.pdf"
)
