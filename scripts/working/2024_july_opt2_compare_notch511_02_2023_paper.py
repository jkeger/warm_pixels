...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.2644035007111), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.574571053413616), 
                                           w=w, 
                                           A=float(0.13100232755205), 
                                           B=float(0.46402063436215), 
                                           C=float(0.4049770380858), 
                                           tau_a=float(0.40486926755427155), 
                                           tau_b=float(4.028455449968522), 
                                           tau_c=float(18.120476613635322),
                                           notch=float(51.1)
                                          )
                print('Done!')
...
Paolo_autofit_global_50_after(
    ...
    save_path_newfig1=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_02_2023_newfig1.pdf",
    save_path_newfig2=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_02_2023_newfig2.pdf"
)
