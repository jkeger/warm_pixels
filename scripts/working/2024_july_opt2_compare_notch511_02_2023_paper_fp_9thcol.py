...
def Paolo_autofit_global_50_after(group1: QuadrantGroup, group2: QuadrantGroup, use_corrected=False, save_path=None, 
                                  save_path_newfig1 = None, save_path_newfig2 = None): 
...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.46054272611923), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.6188773229148774), 
                                           w=w, 
                                           A=float(0.1291186697875), 
                                           B=float(0.44923970557431), 
                                           C=float(0.42164162463819), 
                                           tau_a=float(0.4008370420833771), 
                                           tau_b=float(3.951269631628366), 
                                           tau_c=float(19.6025479421781),
                                           notch=float(145.38953945779974)
                                          )
                print('Done!')
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_freeparams_1.0", "02_2023_2024_july_freeparams_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_02_2023_fp_9thcol.pdf",
    save_path_newfig1=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_02_2023_newfig1_fp_9thcol.pdf",
    save_path_newfig2=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_02_2023_newfig2_fp_9thcol.pdf"
)
