...
def Paolo_autofit_global_50(group: QuadrantGroup, use_corrected=False, save_path=None): 
    ...
    def sunspot_rho_q_pwlinear_fixeddates(dates_since_launch, 
                                          #param_vals = [0.0169, 0.0003956, 0.0007313, 0.00049202, 0.0004227, 0.0004358], #v1, May 2025
                                          param_vals = [0.01322194, 0.00039995, 0.00071063, 0.00049634, 0.00040978, 0.00045308],
                                          gradient_at_eol = 4.755e-4, #4.72e-04
                                         ):    
        ...
        for i in range(len(step_dates)-1):
            rho_q_model += (np.maximum(np.minimum(dates_since_launch,step_dates[i+1]),step_dates[i]) - step_dates[i]) * gradients[i]
    ...
    rho_q = sunspot_rho_q_pwlinear_fixeddates(days_var, param_vals = [0.0169, 0.0003956, 0.0007313, 0.00049202, 0.0004227, 0.0004358],
...
#     elif days_var < 3961.92584_notch511_piecewise00728617:
#         rho_q=rho_q-0.037586665739412245+2.74840460582629e-05*(days_var-1586.5) # m2=vals2 c1=vals4
#     elif days_var > 3961.92584_notch511_piecewise00728617:
#         rho_q=rho_q-0.037586665739412245+2.74840460582629e-05*(3961.92584_notch511_piecewise00728617-1586.5)-9.500901967932416e-06*(days_var-3961.92584_notch511_piecewise00728617) #m3=vals3 t2=vals5    
# =============================================================================
...
# =============================================================================
    ...
    writefilename=f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}" 
    ...
    csv_list=[x for x in csvs_string if f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}" in x]
    print(csv_list)
    csv_name=str(os.path.basename(csv_list[0]))
    print(csv_name)
    target2=path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}", "csv_files",
                     str(csv_name))
...
cosma_output_path = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}")
...
base_dir = os.path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}")
os.makedirs(base_dir, exist_ok=True)

sub_dir_1 = os.path.join(base_dir, f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}")
...
Paolo_autofit_global_50(
    group,
    save_path=Path(path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}",
                     f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}"))/f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}.png"
)
...
for file in files_bia:
    ...
    output_path = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6","richard_scripts", f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}", 
                            f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}", filename)
...
for file in files:
    ...
    image_A, image_B, image_C, image_D = [
        ImageACS.from_fits(
            ...
            bias_file_path=path.join(path.sep, "cosma5", "data", "durham", "dc-barr6","richard_scripts", f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}", 
                                    f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}")
        ).native
        for quadrant in ["A", "B", "C", "D"]
    ]
...
# =============================================================================
    ...
    #  Print results to csv file 
    writefilename=f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}_corrected"
    with open(writefilename+'.csv', 'w', newline='') as file:
        writer = csv.writer(file)
    ...
    for stuff in csvs_all:
        csvs_string.append(str(stuff))
    csv_list=[x for x in csvs_string if f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}_corrected" in x]
    print(csv_list)
    csv_name=str(os.path.basename(csv_list[0]))
    print(csv_name)
    target3=path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts",f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}",
                     "csv_files", str(csv_name))
    shutil.copyfile(csv_list[0],target3)

# Import data to be fitted
cosma_dataset_path = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts",f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}",
                               f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}")
...
Paolo_autofit_global_50_after(
    group,
    save_path=Path(path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", f"2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}",
                     f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}"))/f"{dataset_date}_2024_july_opt2_beta584_notch511_piecewise_v2_{const_fix}_corrected.png"
)
