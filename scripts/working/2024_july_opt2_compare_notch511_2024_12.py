...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.56270185985515), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.5810715484119281), 
                                           w=w, 
                                           A=float(0.12911328185348), 
                                           B=float(0.24525574393094), 
                                           C=float(0.62563097421558), 
                                           tau_a=float(0.4331836708877007), 
                                           tau_b=float(2.910567469795612), 
                                           tau_c=float(10.985381476947019),
                                           notch=float(51.1)
                                          )
                print('Done!')
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_opt2_notch511_1.0", "2024_12_Lmid_2024_july_opt2_notch511_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2024_12.pdf"
)
