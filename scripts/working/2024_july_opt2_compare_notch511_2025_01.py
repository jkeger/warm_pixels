...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.50434052277873), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.5708692065856803), 
                                           w=w, 
                                           A=float(0.13133723147204), 
                                           B=float(0.36163979978328), 
                                           C=float(0.50702296874468), 
                                           tau_a=float(0.4204315958457172), 
                                           tau_b=float(3.426439838525185), 
                                           tau_c=float(15.717043438238104),
                                           notch=float(51.1)
                                          )
                print('Done!')
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_opt2_notch511_1.0", "2025_01_TmidLong_2024_july_opt2_notch511_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_notch511_2025_01.pdf"
)
