...
starting_directory = r'C:\Users\chipe\Documents\Durham University\warm_pixels\scripts\2024_july_opt2_beta584_notch511_all'
...
for value in log_likelihoods:
    temp_BIC=6*np.log(12*50)-2*value
...
for file in files_uncorrected:
    with open(file, 'r') as file:
        ...
        for row in reader:
            ...
            if 'TrailModel (N=6)' in long_string:
                info_file=long_string
...
print('Number of free parameters = 6')
...
# Save to CSV
df.to_csv('2024_july_opt2_beta584_notch511_all_OUTPUTS.csv', index=False)
