...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.76817874135011), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.5728098819680612), 
                                           w=w, 
                                           A=float(0.11845009532267), 
                                           B=float(0.31145022293374), 
                                           C=float(0.57009968174359), 
                                           tau_a=float(0.43989649726359814), 
                                           tau_b=float(3.523364278356303), 
                                           tau_c=float(15.590017951076014),
                                           notch=float(81.90878291908234)
                                          )
                print('Done!')
...
cosma_dataset_path = path.join(path.sep, "cosma", "home", "dphgals", "rjm", "data", "hst", "cte_april_25", "2024_12_Lmid")
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_opt2_freeparams_1.0", "2024_12_Lmid_2024_july_opt2_freeparams_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_2024_12_Lmid.pdf"
)
