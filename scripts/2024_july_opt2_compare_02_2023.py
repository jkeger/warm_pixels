...
# =============================================================================
                ...
                global_autofit1=trail_model_arctic_notch_pushed_plot(x=pixels, 
                                           rho_q=float(3.48535361237138), 
                                           generated_trails=line1.model_full_trail_untrailed,
                                           beta=float(0.6200062549088575), 
                                           w=w, 
                                           A=float(0.13003036142791), 
                                           B=float(0.45322184476644), 
                                           C=float(0.41674779380564997), 
                                           tau_a=float(0.40755486709539), 
                                           tau_b=float(4.049258197477733), 
                                           tau_c=float(19.87803828811864),
                                           notch=float(145.29889458478908)
                                          )
                print('Done!')
...
cosma_dataset_path2 = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6", "richard_scripts", "2024_july_opt2_freeparams_1.0", "02_2023_2024_july_opt2_freeparams_1.0")
...
Paolo_autofit_global_50_after(
    group1, group2,
    save_path=Path(cosma_output_path)/"2024_july_opt2_compare_02_2023.pdf"
)
