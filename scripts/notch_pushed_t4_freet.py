...
# =============================================================================
    ...
    if days_var < temp_switch_date_since_launch and MJD_var < 53700:
        rho_q=0.0003800468709897067 *days_var+0.03605429620804403
        a = 0.146
        b = 0.594
        C = 0.260
    ...
    elif days_var < temp_switch_date_since_launch and MJD_var > 53700:
        rho_q=0.0007148581906349408*(days_var-1366)+0.0003800468709897067 *1366+0.03605429620804403
        a = 0.146
        b = 0.594
        C = 0.260
        tau_a=0.515/(0.74/0.48)
    ...
    elif days_var > temp_switch_date_since_launch and MJD_var < 56500:
        rho_q=0.0007148581906349408*(days_var-1366)+0.0003800468709897067 *1366+0.03605429620804403
        a = 0.146
        b = 0.594
        C = 0.260
    ...
    elif days_var > temp_switch_date_since_launch and MJD_var > 56500 and MJD_var < 57500:
        rho_q=0.0*(days_var-4166)+0.0007148581906349408*(4166-1366)+0.0003800468709897067 *1366+0.03605429620804403
        a = 0.146
        b = 0.594
        C = 0.260
        tau_a=0.515
    ...
    elif days_var > temp_switch_date_since_launch and MJD_var > 57500:
        rho_q=0.00020643313761426057*(days_var-5166)+0.0*(5166-4166)+0.0007148581906349408*(4166-1366)+0.0003800468709897067 *1366+0.03605429620804403
        a = 0.146
        b = 0.594
        C = 0.260
        tau_a=0.515
...
# =============================================================================
    ...
    writefilename=f"{dataset_date}_notch_pushed_t4_freet_{const_fix}" 
    ...
    csv_list=[x for x in csvs_string if f"{dataset_date}_notch_pushed_t4_freet_{const_fix}" in x]
    print(csv_list)
    csv_name=str(os.path.basename(csv_list[0]))
    print(csv_name)
    target2=path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo", f"notch_pushed_t4_freet_{const_fix}", "csv_files",
                     str(csv_name))
...
cosma_output_path = path.join(cosma_path, "paolo",f"notch_pushed_t4_freet_{const_fix}")
...
dir = os.path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo", f"notch_pushed_t4_freet_{const_fix}")
if not os.path.exists(dir):
    os.mkdir(dir)

dir = os.path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo", f"notch_pushed_t4_freet_{const_fix}",
                 f"{dataset_date}_notch_pushed_t4_freet_{const_fix}")
if not os.path.exists(dir):
    os.mkdir(dir)
...
Paolo_autofit_global_50(
    group,
    save_path=Path(path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo", f"notch_pushed_t4_freet_{const_fix}",
                     f"{dataset_date}_notch_pushed_t4_freet_{const_fix}"))/f"{dataset_date}_notch_pushed_t4_freet_{const_fix}.png"
)
...
for file in files_bia:
    ...
    output_path = path.join(path.sep, "cosma5", "data", "durham", "rjm","paolo", f"notch_pushed_t4_freet_{const_fix}", 
                            f"{dataset_date}_notch_pushed_t4_freet_{const_fix}", filename)
...
for file in files:
    ...
    image_A, image_B, image_C, image_D = [
        ImageACS.from_fits(
            ...
            bias_file_path=path.join(path.sep, "cosma5", "data", "durham", "rjm","paolo", f"notch_pushed_t4_freet_{const_fix}", 
                                    f"{dataset_date}_notch_pushed_t4_freet_{const_fix}")
        ).native
        for quadrant in ["A", "B", "C", "D"]
    ]
...
# =============================================================================
    ...
    #  Print results to csv file 
    writefilename=f"{dataset_date}_notch_pushed_t4_freet_{const_fix}_corrected"
    with open(writefilename+'.csv', 'w', newline='') as file:
        writer = csv.writer(file)
    ...
    for stuff in csvs_all:
        csvs_string.append(str(stuff))
    csv_list=[x for x in csvs_string if f"{dataset_date}_notch_pushed_t4_freet_{const_fix}_corrected" in x]
    print(csv_list)
    csv_name=str(os.path.basename(csv_list[0]))
    print(csv_name)
    target4_freet=path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo",f"notch_pushed_t4_freet_{const_fix}",
                     "csv_files", str(csv_name))
    shutil.copyfile(csv_list[0],target4_freet)

# Import data to be fitted
cosma_dataset_path = path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo",f"notch_pushed_t4_freet_{const_fix}",
                               f"{dataset_date}_notch_pushed_t4_freet_{const_fix}")
...
Paolo_autofit_global_50_after(
    group,
    save_path=Path(path.join(path.sep, "cosma5", "data", "durham", "rjm", "paolo", f"notch_pushed_t4_freet_{const_fix}",
                     f"{dataset_date}_notch_pushed_t4_freet_{const_fix}"))/f"{dataset_date}_notch_pushed_t4_freet_{const_fix}_corrected.png"
)
