...
csv_path = path.join("csv_files_exp2_free")
...
plt.savefig('exp2_free_plots/Beta(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
ax_day.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('exp2_free_plots/a,b,c(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
ax_day.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('exp2_free_plots/tau_a,tau_b,tau_c(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
ax_day.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('exp2_free_plots/CCDGAIN(MJD)', bbox_inches="tight")
plt.show()
...
plt.savefig('exp2_free_plots/correction_metrics(MJD)', bbox_inches="tight")
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
plt.savefig('exp2_free_plots/Notch(MJD)', bbox_inches="tight")
plt.show()
...
plt.savefig('exp2_free_plots/Rho_q(MJD)', bbox_inches="tight")
plt.show()
...
plt.ylim(-25,25)
plt.gca().axes.get_yaxis().set_ticks([])
plt.savefig('exp2_free_plots/Rho_q_post_zoom(MJD)', bbox_inches="tight")
plt.show()
