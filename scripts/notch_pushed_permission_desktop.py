...
# =============================================================================
                ...
                print('generated trails is', line.model_full_trail_untrailed)
...
cosma_dataset_path = path.join(dataset_date)
...
Paolo_autofit_global_50(
    group,
    save_path=f"{dataset_date}_notch_pushed_{const_fix}.png"
)
...
# =============================================================================
                ...
                print('Plotting one autofit subplot...')
                global_autofit=trail_model_arctic_notch_pushed(x=pixels, 
                                           rho_q=float(best_trail_model.rho_q), 
                                           generated_trails=line.model_full_trail_untrailed,
