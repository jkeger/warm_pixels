...
cosma_dataset_path = path.join(path.sep, "cosma5", "data", "durham", "dc-barr6")
cache_directory=Path(cosma_dataset_path)
    ...
    def __call__(self, directory_func=str):
        ...
        def outer(func):
            ...
            def wrapper(instance):
                directory = cache_directory / directory_func(instance)
                path = directory / name
