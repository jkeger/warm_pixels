...
from warm_pixels.hst_functions.trail_model_k import trail_model # Use the version with k constant
...
def plot_stacked_trails(group: QuadrantGroup, use_corrected=False, save_path=None):
    class Analysis(af.Analysis):
        def __init__(self, x, y, noise, n_e, n_bg, row, N):
            self.x = x
            self.y = y
            self.noise = noise
            self.n_e = n_e
    ...
    class TrailModel:
        ...
        def __call__(self, x, n_e, n_bg, row, N):
            return trail_model(
                x=x,
                rho_q=self.rho_q,
                n_e=n_e,
...
# =============================================================================
    ...
    # Or just use pre-calculated values: 
    # Model without +N
 #log likelihood = -5910.688773924896
    #beta = 0.4336971779683304
    #rho_q = 1.84829627610815
    #a = 0.16743421136606
    #b = 0.83127698324167
    #c = 0.0012888053922700538
    #tau_a = 0.5133649517548854
    #tau_b = 5.177584450357047
    #tau_c = 38.293347863416585
    
    #Model with +N
    #log likelihood = -77716.4048511391
    #beta = 0.26132423069520094
    #beta=0.478
    #rho_q = 1.59222762409695
    #a = 0.1376793538598
    #b = 0.84919280071634
    #c = 0.01312784542386003
    #tau_a = 0.48617445983524443
    #tau_b = 6.387551405021592
    #tau_c = 23.575608196556754
    ...
    for i_row in range(n_row_bins):
        for i_flux in range(n_flux_bins):
            ...
            for i_background, c in enumerate(colours):
                ...
                # Don't plot the warm pixel itself
                N_local=min(line.model_trail)
                N_plotted=0
                if N_local<0:
                    trail = np.array(line.model_trail)+abs(N_local)
...
# =============================================================================
                ...
                #print('flux:',adjusted_flux)
                #print('bg:',adjusted_bg)
                #print('N:',N_plotted)
