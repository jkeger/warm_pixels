...
def trail_model_arctic_notch_pushed_slowcap(x, rho_q, generated_trails, beta, w, A, B, C, tau_a, tau_b, tau_c, capt_a, capt_b, capt_c, notch):
    
    # Set up classes required to run arCTIc
    # roe, ccd, traps = ac.CTI_model_for_HST_ACS(date)
    traps = [
        cti.TrapSlowCapture(density=A * rho_q, release_timescale=tau_a, capture_timescale=capt_a),
        cti.TrapSlowCapture(density=B * rho_q, release_timescale=tau_b, capture_timescale=capt_b),
        cti.TrapSlowCapture(density=C * rho_q, release_timescale=tau_c, capture_timescale=capt_c),
    ]
...
def trail_model_arctic_notch_pushed_plot_slowcap(x, rho_q, generated_trails, beta, w, A, B, C, tau_a, tau_b, tau_c, capt_a, capt_b, capt_c, notch):
